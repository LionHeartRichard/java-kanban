...
public class FileBackedTaskManagerTest {
	...
	public void setUpAndSaveDataContainsInObjectFileBackedTaskManager() throws IOException {
		...
		TaskInterface parentB2 = new Task("TASK", "T-4", "Parent B-2", "description parent B-2", Status.NEW);
		parentB2.setStartTime(LocalDateTime.parse("10:00 20.12.2024", DATE_TIME_FORMATTER));
		parentB2.setDuration(Duration.ofMinutes(60));
		TaskInterface childrenB2 = new Task("TASK", "T-5", "children B-2", "description parent B-2", Status.NEW);
		...
		TaskInterface root2 = new Epic("EPIC", "E-1", "ROOT2", "Description for ROOT-2", Status.NEW);
